...
# Correction to account for orientation difference
# between gripper link in URDF vs DH conventions
...
# Numerically evaluate transforms (compare with output of tf echo)
